...
@Entity(name="topup_rate_company")
public class TopupRateCompany implements Serializable {
    ...
    /**
     * Compares the key for this instance with another TopupRateCompany.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class TopupRateCompany and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof TopupRateCompany)) {
            return false;
        }
        TopupRateCompany that = (TopupRateCompany) other;
    ...
    /**
     * Compares this instance with another TopupRateCompany.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof TopupRateCompany)) return false;
        return this.equalKeys(other) && ((TopupRateCompany)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[TopupRateCompany |");
