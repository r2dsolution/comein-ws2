...
public class PayTransaction implements Serializable {
    ...
    /**
     * Compares the key for this instance with another PayTransaction.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class PayTransaction and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof PayTransaction)) {
            return false;
        }
        PayTransaction that = (PayTransaction) other;
    ...
    /**
     * Compares this instance with another PayTransaction.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof PayTransaction)) return false;
        return this.equalKeys(other) && ((PayTransaction)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[PayTransaction |");
